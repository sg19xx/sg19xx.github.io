...
function main() {
    ...
    h2.textContent = "Меня зовут Сергей. Являюсь Front-end разработчиком сайтов и веб-приложений. Для ознакомления с моим творчеством к вашему вниманию раздел работы.";
